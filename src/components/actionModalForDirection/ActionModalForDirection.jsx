...
const ActionModalForDirection = ({ active, setActive, closeModal, onChangeClick, onDeleteClick }) => {
    return (
      <Modal active={active} setActive={setActive} height="200px">
...
export default ActionModalForDirection